...
/**
 * Dans la classe EvenementCulturel, nous créons un évènement de type culturel.
 *
 * @author julien choukroun
 * @author jessica gourdon
 *
 */
public class EvenementCulturel extends Evenement {
    // L'évènement est du type culturel.
    private String type = "Culturel";
    ...
    /**
     * Crée un évènement de type culturel par défaut.
     ...
     */
    public EvenementCulturel(String titre, int dateDebut, int dateFin, String lieu, boolean places){
    ...
    /**
     * Crée un évènement de type culturel.
     ...
     */
    public EvenementCulturel(String titre, int dateDebut, int dateFin, String lieu, boolean places, int prix){
        super(titre, dateDebut, dateFin, lieu);
        setReference();
        payant = true;
        this.prix = prix;
